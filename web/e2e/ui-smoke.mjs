...
await page.getByText("管理员与会话").waitFor()
await page.getByLabel("启用 ChatGPT").click()
await page.getByRole("button", { name: "测试已启用站点" }).click()
...
await page.getByRole("button", { name: "跟随系统，点击切换" }).first().click()
await page.getByRole("button", { name: "明亮主题，点击切换" }).first().click()
...
await page.goto(`${baseURL}/#/settings`, { waitUntil: "networkidle" })
await page.getByLabel("当前密码").fill("ui-review-password-2026")
